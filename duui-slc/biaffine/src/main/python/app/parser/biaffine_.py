...
class BiaffineProcessor(ProcessorABC[Dataset]):
    ...
    def post_process(annotations: list[CoNLLSentence], offsets: list[Offset]):
        ...
        for annotation, offset in zip(annotations, offsets):
            ...
            for head, rel, start_char, end_char, upos, xpos, lemma, feats in \
                zip(annotation.arcs, annotation.rels, annotation.start_char, annotation.end_char, annotation.upos, annotation.xpos, annotation.lemma, annotation.feats):
