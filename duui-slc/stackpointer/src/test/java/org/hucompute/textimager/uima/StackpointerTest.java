...
public class StackpointerTest {
    ...
    static void beforeAll() throws CompressorException, URISyntaxException, IOException, UIMAException, SAXException {
        ...
        // composer.add(
        //         new DUUIDockerDriver.Component("duui-slc-biaffine/cu124:0.0.1"));
    ...
    @Test
    public void dependencyParsingStackpointerTestEn() throws Exception {
        System.out.println("dependencyParsingStackpointerTestEn");
        ...
        String[] casDepTypes = JCasUtil.select(cas, Dependency.class)
                ...
                .toArray(String[]::new);
        String[] depTypes = {"nsubj", "aux", "advmod", "--", "mark", "xcomp", "amod", "obj", "punct", "--", "cop", "nummod", "nsubj", "punct", "cc", "fixed", "fixed", "det", "conj", "case", "amod", "nmod", "case", "nmod", "punct", "case", "obl", "punct", "compound", "compound", "nsubj", "--", "compound:prt", "det", "obj", "mark", "acl", "det", "obj", "case", "nmod:poss", "obl", "mark", "advcl", "det", "obj", "case", "nummod", "obl", "case", "nmod", "punct", "advmod", "advmod", "punct", "det", "nsubj", "cop", "det", "nummod", "compound", "--", "punct", "nsubj", "acl:relcl", "compound:prt", "obj", "case", "nmod:poss", "compound", "compound", "nmod", "det", "obl:tmod", "punct", "--", "cop", "nsubj", "case", "obl", "punct"};
        System.out.println("helloo");
        System.out.println(depTypes.length);
        System.out.println(casDepTypes.length);
        ...
        int[] depBegins = {0, 4, 11, 18, 22, 25, 31, 36, 45, 47, 53, 57, 61, 69, 71, 74, 79, 82, 87, 93, 99, 104, 114, 117, 124, 126, 129, 133, 135, 142, 150, 158, 162, 165, 167, 174, 177, 182, 186, 193, 199, 203, 209, 212, 217, 219, 224, 229, 233, 239, 242, 249, 251, 257, 270, 272, 276, 283, 287, 289, 293, 298, 306, 308, 314, 321, 324, 328, 331, 335, 342, 347, 354, 359, 363, 365, 370, 373, 376, 379, 383};
        ...
        int[] depEnds = {3, 10, 17, 21, 24, 30, 35, 45, 46, 52, 56, 60, 69, 70, 73, 78, 81, 86, 92, 98, 103, 113, 116, 124, 125, 128, 133, 134, 141, 149, 157, 161, 164, 166, 173, 176, 181, 185, 192, 198, 202, 208, 211, 216, 218, 223, 228, 232, 238, 241, 249, 250, 256, 270, 271, 275, 282, 286, 288, 292, 297, 306, 307, 313, 320, 323, 327, 330, 334, 341, 346, 353, 358, 363, 364, 369, 372, 375, 378, 383, 384};    
        assertArrayEquals(depEnds, casDepsEnds);

        System.out.println("Test dependencyParsingStackpointerTestEn Passed!");
