...
public class BiaffineTest {
    ...
    @Test
    public void dependencyParsingBiaffineTestEn() throws Exception {
        System.out.println("dependencyParsingBiaffineTestEn");
        ...
        String[] depTypes = {
                ...
                "amod", "compound", "nmod", "det", "obl:tmod", "punct", "--", "cop", "nsubj",
                "case", "obl", "punct"
        };
        ...
        System.out.println("Test dependencyParsingBiaffineTestEn Passed!");
